        ...
        <div class="flex justify-between h-20">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-4 sm:-my-px sm:ms-10 lg:flex items-center">
                    ...
                    <x-nav-link :href="route('admin_pc.pengkaderan.index')" :active="request()->routeIs('admin_pc.pengkaderan.*')">
                        Pengkaderan
                    </x-nav-link>
            ...
            <div class="hidden lg:flex sm:items-center sm:ms-6">
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="w-10 h-10 rounded-full bg-emerald-600 flex items-center justify-center text-white font-black text-sm uppercase hover:bg-emerald-700 transition-colors shadow-md">
        ...
        <div class="fixed inset-0 flex justify-end">
            <div x-show="open" x-transition:enter="transition ease-in-out duration-300 transform" x-transition:enter-start="translate-x-full" x-transition:enter-end="translate-x-0" x-transition:leave="transition ease-in-out duration-300 transform" x-transition:leave-start="translate-x-0" x-transition:leave-end="translate-x-full" class="relative ml-auto flex h-full w-full max-w-xs flex-col overflow-y-auto bg-white py-4 pb-12 shadow-xl">
                ...
                <div class="flex items-center justify-between px-6 pb-6 border-b border-slate-100">
                    ...
                    <button type="button" class="-mr-2 flex h-10 w-10 items-center justify-center rounded-xl bg-slate-50 text-slate-400 hover:text-emerald-600" @click="open = false">
                ...
                <div class="mt-6 px-4 space-y-1">
                    ...
                    <div class="pt-6 pb-2">
                        ...
                        <x-responsive-nav-link :href="route('admin_pc.pengkaderan.index')" :active="request()->routeIs('admin_pc.pengkaderan.*')" class="flex items-center gap-3">
                            <svg class="w-5 h-5 opacity-70" fill="none" stroke="currentColor" viewBox="0 0 24 24">
