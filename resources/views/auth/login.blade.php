...
<head>
    ...
    <title>Masuk Sistem - {{ config('app.name', 'Satria Tulungagung') }}</title>
        ...
        <div class="w-full sm:max-w-[480px] bg-white shadow-2xl shadow-slate-200/60 overflow-hidden rounded-[2.5rem] border border-white">
            ...
            <div class="pt-12 pb-8 px-8 text-center">
                ...
                <h2 class="text-2xl font-black text-slate-800 tracking-tight uppercase leading-none">
                    Sistem Informasi <br><span class="text-emerald-600">Terpadu</span>
                </h2>
            ...
            <div class="px-8 pb-10 md:px-12 md:pb-12 bg-white">
                ...
                <div class="mb-6 p-4 bg-rose-50 border border-rose-100 rounded-2xl flex gap-3 items-start">
                    ...
                    <div>
                        <h4 class="text-xs font-bold text-rose-700 uppercase tracking-wide">Gagal Masuk</h4>
                ...
                <div class="relative flex py-8 items-center">
                    ...
                    <span class="flex-shrink-0 mx-4 text-[10px] text-slate-300 font-black uppercase tracking-widest">Informasi Akses</span>
                    <div class="flex-grow border-t border-slate-100"></div>
                </div>
                ...
                <div class="bg-slate-50/50 rounded-2xl p-5 border border-slate-100">
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h5 class="text-xs font-bold text-slate-700 uppercase tracking-wide mb-1">Autentikasi Terpadu</h5>
                            <p class="text-xs text-slate-500 font-medium leading-relaxed">
                                Silakan masuk menggunakan akun Google aktif Anda. Apabila ini adalah kunjungan pertama, sistem akan secara otomatis mengarahkan Anda ke halaman pendaftaran anggota baru.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="text-center pt-8">
                    <p class="text-xs text-slate-400 font-medium">
                        Belum terdaftar di database kami?
                    </p>
                    <a href="{{ route('register') }}" class="inline-block mt-2 text-sm font-black text-emerald-600 hover:text-emerald-800 transition-colors uppercase tracking-wide hover:underline decoration-2 underline-offset-4">
                        Registrasi Anggota Baru &rarr;
                    </a>
                </div>
